defmodule Agento.IndividualContextTest do
  ...
  describe "individuals" do
    ...
    @valid_attrs %{birthdate: ~D[2010-04-17], firstname: "some firstname", gender: "some gender", lastname: "some lastname", native_language_code: "some native_language_code"}
    @update_attrs %{birthdate: ~D[2011-05-18], firstname: "some updated firstname", gender: "some updated gender", lastname: "some updated lastname", native_language_code: "some updated native_language_code"}
    @invalid_attrs %{birthdate: nil, firstname: nil, gender: nil, lastname: nil, native_language_code: nil}
