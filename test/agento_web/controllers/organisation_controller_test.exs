defmodule AgentoWeb.OrganisationControllerTest do
  use AgentoWeb.ConnCase

  alias Agento.OrganisationContext

  @create_attrs %{abbreviation: "some abbreviation", begindate: ~N[2010-04-17 14:00:00], description: "some description", enddate: ~N[2010-04-17 14:00:00], foundationdate: ~D[2010-04-17], is_deleted: true, name: "some name", popularname: "some popularname"}
  ...
  def fixture(:organisation) do
    {:ok, organisation} = OrganisationContext.create_organisation(@create_attrs)
    organisation
  end
