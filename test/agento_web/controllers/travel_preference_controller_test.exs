defmodule AgentoWeb.TravelPreferenceControllerTest do
  ...
  @create_attrs %{has_wheelchair: true, homeairport_location: "some homeairport_location", labelname: "some labelname", mealtype_code: "some mealtype_code", preferred_aircraft_seat_type_code: "some preferred_aircraft_seat_type_code", smoker: true}
